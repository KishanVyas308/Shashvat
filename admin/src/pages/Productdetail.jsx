        ...
        <div className="max-w-4xl mt-4 mx-auto p-6 bg-white shadow-lg rounded-lg">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 lg:pl-6 mt-6 lg:mt-0">
              ...
              <table className="mb-4 mt-2 w-full border-collapse border border-gray-200">
                <tbody>
                  <tr>
                    <td className="border border-gray-200 px-4 py-2 font-bold">MOQ:</td>
                    <td className="border border-gray-200 px-4 py-2">{product.moq} Piece</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-2 font-bold">Business Type:</td>
                    <td className="border border-gray-200 px-4 py-2">Manufacturers, Wholesaler, Supplier</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-2 font-bold">Country of Origin:</td>
                    <td className="border border-gray-200 px-4 py-2">India</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-2 font-bold">Size:</td>
                    <td className="border border-gray-200 px-4 py-2">{product.size}</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 px-4 py-2 font-bold">Material:</td>
                    <td className="border border-gray-200 px-4 py-2">{product.material}</td>
                  </tr>
              ...
              <div className="flex items-center my-2">
                ...
                {userAtm && userAtm.isAdmin === true && (
                  <div className="mx-5 z-30">
                    <DeleteProductButton productId={params.id} imgUrl={product.imgUrl} />
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="mt-6 bg-gray-100 p-6 rounded-lg shadow-inner">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <p><strong>Shape:</strong> {product.details.shape ? product.details.shape : '----'}</p>
              </div>
              <div>
                <p><strong>Color:</strong> {product.details.color ? product.details.color :'----'}</p>
              </div>
              <div>
                <p><strong>Pattern:</strong> {product.details.pattern ? product.details.pattern:'----'}</p>
              </div>
              <div>
                <p><strong>Finish:</strong> {product.details.finish ? product.details.finish:'----'}</p>
              </div>
            </div>
          </div>
        </div>
