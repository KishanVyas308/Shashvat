const seoData = {
    home: {
      ...
      description: "Shashvat EnterPrise located in Jamnagar. We specialize in production, manufacturing, and supplying components, sanitary Bath fitting, and hardware ,  products.",
